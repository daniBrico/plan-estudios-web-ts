    ...
    <>
      {isMobile ? (
        ...
        <Button
          ...
          handleClickCallback={handleButtonToTop}
          cssClasses={`right-8 bottom-20 h-13 w-13 rounded-4xl hover:bg-first-color/90 hover:scale-110 transition-transform duration-300 ${showButton ? 'opacity-100' : 'pointer-events-none opacity-0'}`}
        />
      )}
    </>
  )
